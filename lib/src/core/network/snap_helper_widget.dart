        ...
        if (!useConnectionStateForLoader) {
          ...
          switch (snap.connectionState) {
            ...
            case ConnectionState.active:
              return loadingWidget ??  CircularProgressIndicator( color: context.theme.primaryColor);
            case ConnectionState.done:
              ...
              if (!snap.hasData) {
                ...
                return errorWidget ??
               Text(defaultErrorMessage ?? snap.error.toString(), style:FuTextStyle. primaryTextStyle()) .center();
              }
            default:
